...
6. Usa la terminal solo para el comando de la skill. Para leer el ticket o la bitácora, o comprobar si existen, usa `read/readFile`.
7. Responde al operador con el procedimiento aplicado, el hallazgo en una línea técnica, el resultado y, si hay, el mensaje para el usuario en español llano, sin términos de la lista de jerga.
